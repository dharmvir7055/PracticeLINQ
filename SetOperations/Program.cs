...
namespace SetOperations
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            teachers.IntersectBy(students.Select(st => (st.FirstName, st.LastName)), teacher => (teacher.First, teacher.Last));//select only same names
            ...
            */
            ...
            var people = teachers.Select(tt => (FirstName: tt.First, LastName: tt.Last)).UnionBy(students.Select(st => (st.FirstName, st.LastName)), teacher => (teacher.FirstName, teacher.LastName));//select all name but remove duplicats
